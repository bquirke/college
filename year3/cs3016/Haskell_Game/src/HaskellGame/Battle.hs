...
instance Combatant Player where -- Task 2 : need to implement the five functions below
  ...
  attack (Player _ _ stren skill _) = snd (stren List.!! 0) * snd (skill List.!! 0)

  defense (Player _ _ stren _ _) = snd (stren List.!! 1)

  level (Player _ _ stren _ _) = floor (log (fromIntegral (snd (stren List.!! 0) + snd (stren List.!! 1))))
