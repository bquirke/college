...
public class NumberPalindromeTest
{
	...
	{
		assertEquals("Testing LargestPalindromeNDigitProduct", 906609, NumberPalindrome.largestPalindromeNDigitProduct(3));
		assertEquals("Testing LargestPalindromeNDigitProduct", 99000099, NumberPalindrome.largestPalindromeNDigitProduct(4));
		assertEquals("Testing LargestPalindromeNDigitProduct", 9966006699L, NumberPalindrome.largestPalindromeNDigitProduct(5));
		assertEquals("Testing LargestPalindromeNDigitProduct", 999000000999L, NumberPalindrome.largestPalindromeNDigitProduct(6));
		assertEquals("Testing LargestPalindromeNDigitProduct", 99956644665999L, NumberPalindrome.largestPalindromeNDigitProduct(7));
	}
